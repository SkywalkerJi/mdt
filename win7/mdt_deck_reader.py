...
def get_deck_dict():
    ...
    ma_count_static = 0x01FF6F58
    ma_count_offsets = [0xB8, 0x0, 0x108, 0x1F8, 0xF0, 0x18]
    ex_count_static = 0x01FF6F58
    ex_count_offsets = [0xB8, 0x0, 0x108, 0x1F8, 0xF8, 0x18]
    ma_cards_static = 0x01FF6F58
    ma_cards_offsets = [0xB8, 0x0, 0x108, 0x1F8, 0x148, 0x10, 0x20]
    ex_cards_static = 0x01FF6F58
    ex_cards_offsets = [0xB8, 0x0, 0x108, 0x1F8, 0x150, 0x10, 0x20]
...
def _check_two_array_not_same(deck1: list, deck2: list):
    """
...
def check_deck(ydk_deck: list, locale):
    _dict = get_deck_dict()
